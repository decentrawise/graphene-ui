...
import {Signature, ChainStore, PublicKey} from "@decentrawise/graphenejs";
import WalletUnlockActions from "actions/WalletUnlockActions";
import WalletDb from "stores/WalletDb";

const MSG_HEAD = "-----BEGIN GRAPHENE SIGNED MESSAGE-----";
const MSG_META = "-----BEGIN META-----";
const MSG_SIGNATURE = "-----BEGIN SIGNATURE-----";
const MSG_FOOT = "-----END GRAPHENE SIGNED MESSAGE-----";
...
class SignedMessageAction {
     ...
     *                      block : Current last irreversible block of the graphene blockchain
