...
import {Popover} from "graphene-ui-style-guide";
import {ChainStore, FetchChainObjects} from "@decentrawise/graphenejs";
import GatewayStore from "../../stores/GatewayStore";
import {getAssetAndGateway} from "common/gatewayUtils";
import {Icon, Tooltip} from "graphene-ui-style-guide";
    ...
    render() {
        ...
        if ((replace && replacedName !== name) || isBitAsset) {
            ...
            if (!!noTip) {
                ...
                let desc = null;
                if (replacedName == chainConfig.core_asset) {
                    desc = {main: counterpart.translate("assets.CORE")};
                } else {
