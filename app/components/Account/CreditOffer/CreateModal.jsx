...
class CreateModal extends React.Component {
    ...
    _delWhitelistItem(account) {
        let {whitelist} = this.state;
        let index = whitelist.findIndex(v => v.account.get("name") == account);
...
class CreateModalConnectWrapper extends React.Component {
    render() {
        return <CreateModal {...this.props} ref={this.props.refCallback} />;
    }
}
