...
import {
    ...
    FetchChain,
    FetchChainObjects
} from "@decentrawise/graphenejs/es";
...
import {Button, Row, Col, Icon, Tooltip, Switch} from "graphene-ui-style-guide";
...
import chainConfig from "chain/chainConfig.js";
...
class InvoicePay extends React.Component {
    ...
    _printExampleInvoice() {
        let invoice = {
            to: "sschiessl",
            to_label: "Stefan S.",
            currency: chainConfig.core_asset,
            memo: "Invoice #1234",
            line_items: [
    ...
    render() {
        ...
        if (this.state.invoiceQr) {
            ...
            if (
                ...
                qrcode =
                    `graphene:operation/transfer?to=${invoice.to}&from=${this.state.pay_from_name}&asset=${asset}&amount=${total_amount}` +
