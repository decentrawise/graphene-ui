...
import {Tooltip} from "graphene-ui-style-guide";
...
class Footer extends React.Component {
    ...
    componentDidMount() {
        ...
        this.downloadLink =
            "https://github.com/decentrawise/graphene-ui/releases/latest";
    ...
    checkNewVersionAvailable() {
        if (__ELECTRON__) {
            fetch(
                "https://api.github.com/repos/decentrawise/graphene-ui/releases/latest"
            )
                .then(res => {
                    return res.json();
                })
                            ...
                            >
                                ...
                                <span style={updateStyles}>
                                    ...
                                    {__GIT_BRANCH__ === "staging" ? (
                                        <a
                                            href={`https://github.com/decentrawise/graphene-ui/commit/${version.trim()}`}
