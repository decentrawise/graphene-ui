...
import {Alert, Icon} from "graphene-ui-style-guide";
import {Carousel} from "antd";
import SettingsActions from "actions/SettingsActions";
import {connect} from "alt-react";
import SettingsStore from "stores/SettingsStore";
import {hash} from "@decentrawise/graphenejs";
...
class NewsHeadline extends React.Component {
    ...
    getNewsFromGitHub() {
        fetch(
            "https://api.github.com/repos/decentrawise/graphene-ui/contents/news.json"
        )
            .then(res => {
                return res.json();
            })
