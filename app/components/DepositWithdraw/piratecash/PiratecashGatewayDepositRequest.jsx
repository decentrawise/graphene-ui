...
import {ChainStore} from "@decentrawise/graphenejs/es";
import ChainTypes from "components/Utility/ChainTypes";
import BindToChainState from "components/Utility/BindToChainState";
import PiratecashWithdrawModal from "./PiratecashWithdrawModal";
import AccountBalance from "../../Account/AccountBalance";
import PiratecashDepositAddressCache from "lib/common/PiratecashDepositAddressCache";
...
import {Modal} from "graphene-ui-style-guide";
...
class XbtsxGatewayDepositRequest extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.deposit_address_cache = new PiratecashDepositAddressCache();
