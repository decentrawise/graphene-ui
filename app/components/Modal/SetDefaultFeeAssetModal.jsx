...
import {Table, Button, Radio, Modal, Checkbox} from "graphene-ui-style-guide";
...
class SetDefaultFeeAssetModal extends React.Component {
    ...
    _getColumns() {
        const symbolSorter = (a, b) => {
            if (
                a.asset == chainConfig.core_asset ||
                b.asset == chainConfig.core_asset
            ) {
                return a.asset == chainConfig.core_asset ? 1 : -1;
            } else if (
