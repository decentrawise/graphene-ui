...
CORE'le temasınızı arttırmak ve USD,EUR,GOLD gibi BitAktiflere likidite sağlamak için 
 ...
 * *uzlaşma fiyatı* : 1 CORE in dış borsalarda alıp-satılırkenki fiyatı.
...
fiyatından(x/CORE) daha düşük olduğu anda teminatı zorla sattırılır.
...
piyasa fiyatından satın alır ve pozisyonu kapar. Teminattan geri kalan CORE müşteriye 
iade edilir.
...
teminat oranı arttırılırsa , ilave miktarda CORE teminat olarak kilit altına alınır, teminat 
