...
Graphene(比特股) 2.0 是一个金融智能合约平台，[Graphene(石墨烯)](https://github.com/decentrawise/graphene)技术开发。Graphene(石墨烯)是一个开发工具包，同时也是实时区块链的技术实现。

本帮助文档旨在提供用户一个系统概述，并解释系统中的一些基本概念。

## 简介
 * [Graphene(比特股)](introduction/graphene.md)
