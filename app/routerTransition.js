import {Apis, Manager} from "@decentrawise/graphenejs-ws";
...
import {Notification} from "graphene-ui-style-guide";
...
class RouterTransitioner {
    ...
    /**
     *
     * @param apiNodeUrl the url of the target node
...
class Pinger {
    /**
     * @param connectionManager graphenejs ConnectionManager
